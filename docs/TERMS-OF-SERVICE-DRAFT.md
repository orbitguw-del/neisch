...
> SaaS lawyer for compliance with the Indian Contract Act, Consumer
> Protection Act 2019, and IT Act 2000 before being published at
> `storeyinfra.com/terms`.
...
By creating an account on the Storey application, by signing in to
Storey using any method (email, Google sign-in, phone OTP, invite
link), or by using any feature of Storey, you agree to these Terms
of Service and our [Privacy Policy](./privacy).

If you are accepting these terms on behalf of a company or other
organisation, you confirm that you have the authority to bind that
...
**Storey Infra**, an Indian business based in Guwahati, Assam.

Storey is being organised as a private limited company. Until that
...
account. Notify us immediately at +91 98640 66898 if you suspect any
unauthorised access.

### 4.3 Team access
If you are a contractor administering a tenant workspace, you are
responsible for the users you invite to that workspace. Their conduct
within your tenant is your responsibility.

## 5. Your data — ownership and licence

### 5.1 Your data remains yours
The data you input into Storey — site information, worker data,
material records, photos, tasks, expenses, etc. — remains your
property. You retain all rights, title, and interest in this data.

### 5.2 Licence to operate Storey
By using Storey, you grant us a limited, non-exclusive, revocable
...
(typically tax records or pending disputes).

## 6. Acceptable use

You agree NOT to use Storey to:

- Violate any Indian or international law
...
early-stage testers will receive founder-pricing terms which we will
communicate in writing with at least 30 days' notice before any
billing begins.

### 7.3 Future invoicing
Once invoicing begins:
- Fees are payable monthly in advance
- GST will be added as applicable under Indian tax law
- Payment can be made via UPI, bank transfer, or supported payment
  gateways
- Late payments may result in service suspension after 15 days of
  non-payment

### 7.4 Refunds
Pro-rated refunds are available for cancellations within the first
30 days of a paid plan, at our reasonable discretion. After 30 days,
fees are non-refundable but you can cancel any time to stop future
billing.

## 8. Disclaimers

### 8.1 Service "as-is"
Storey is provided "AS IS" and "AS AVAILABLE" during the beta period.
...
- **No consequential damages:** We are not liable for indirect,
  ...
  but not limited to loss of profits, loss of business opportunity,
...
### 11.1 By you
You can terminate your account at any time via the in-app account
settings, or by contacting us. Termination triggers the data
retention and deletion process described in our Privacy Policy.
...
- We'll notify active users at least 30 days before the change takes
  effect, via email + in-app notification
- Continued use of Storey after the change indicates your acceptance
- If you don't agree, you can terminate your account before the
  change takes effect
...
- **Entire agreement:** These Terms, together with our Privacy
  ...
  regarding Storey, superseding any prior agreements.
- **No waiver:** Our failure to enforce any provision does not waive
