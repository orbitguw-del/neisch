        ...
        <div className="ml-auto flex items-center gap-2">
          <button
            onClick={() => {
              ...
              const lines = [
                `📦 Materials In — ${monthLabel(month)}`,
                `Site: ${siteName}`,
                ``,
                `Materials received: ${monthlyData.rows.length}`,
                `💰 Total spend: ${fmtINR(monthlyData.totalCost)}`,
              ]
...
export default function Reports() {
  ...
  return (
    <div>
      ...
      <div className="no-print border-b border-gray-200 mb-6 overflow-x-auto">
